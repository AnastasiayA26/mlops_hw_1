...
class ProcessingService:
    ...
    def process_single_file(self, file_path):
        try:
            ...
            processed_df, cat_features = preproc.preprocess_data(input_df)
            ...
            scorer.save_feature_importance(self.output_dir, json_filename)
            ...
            scorer.save_prediction_plot(submission['prediction'], self.output_dir, density_filename)
